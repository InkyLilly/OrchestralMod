 ...
 *
 */
package net.mcreator.orchestral;
...
@Mod("orchestral")
public class OrchestralMod {
	public static final Logger LOGGER = LogManager.getLogger(OrchestralMod.class);
	public static final String MODID = "orchestral";
